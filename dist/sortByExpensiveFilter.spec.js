...
const test_2 = __importDefault(require("./test"));
const logger_utils_1 = __importDefault(require("../utils/logger.utils"));
(0, test_2.default)('Sorting by expensive filter', async ({ app, page, browser }) => {
    ...
    logger_utils_1.default.step("Нажимаем на 'дорогие'");
    await app.searchByParameters.chooseSortingType(search_by_parameters_fixture_1.SortingTypes.Expensive);
    logger_utils_1.default.step("Ожидаем...");
    await app.searchByParameters.waiter();
    logger_utils_1.default.step("Получаем максимальную цену из массива цен");
